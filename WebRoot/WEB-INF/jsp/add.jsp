...
<body>
	<div class="container">
		...
		<div class="form-group has-success">
			...
			<input type="text" name="usercode" class="form-control" id="inputSuccess1">
		</div>
		<div class="form-group has-warning">
			<label class="control-label" for="inputWarning1">用戶名稱</label>
			 <input type="text" name="username" class="form-control" id="inputWarning1">
		</div>
		<div class="form-group has-error">
			<label class="control-label" for="inputError1">用戶密碼</label> 
			<input type="text" name="userpassword" class="form-control" id="inputError1">
		</div>
